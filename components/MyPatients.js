...
export default class MyPatients extends Component {
  ...
  constructor(props) {
    ...
    this.array = [
      {
        title: 'Amy Farha - Cancer'
      },
      {
        title: 'Chris Jackson - High Blood Pressure'
      },
      {
        title: 'Jamie - Diabetes'
      },
      {
        title: 'Mandy - Malaria'
      },
      {
        title: 'Cole - Depression'
      }
    ],
        this.state = {
          arrayHolder: [],
  ...
  render () {
    return (
      <View style={styles.container}>
        <Text style={styles.text}> My Patients List </Text>
        
        <TextInput
          placeholder="name - health problem"
